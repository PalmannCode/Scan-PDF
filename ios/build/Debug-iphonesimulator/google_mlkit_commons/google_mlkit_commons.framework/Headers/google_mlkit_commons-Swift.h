...
#ifndef GOOGLE_MLKIT_COMMONS_SWIFT_H
#define GOOGLE_MLKIT_COMMONS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="google_mlkit_commons",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20google_mlkit_commons19GenericModelManager")
@interface GenericModelManager : NSObject
- (void)manageModel:(MLKRemoteModel * _Nonnull)model call:(FlutterMethodCall * _Nonnull)call result:(FlutterResult _Nonnull)result;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol FlutterPluginRegistrar;
SWIFT_CLASS("_TtC20google_mlkit_commons24GoogleMlKitCommonsPlugin")
...
@class NSString;
@interface MLKVisionImage (SWIFT_EXTENSION(google_mlkit_commons))
/// Creates a VisionImage from method-channel imageData. Returns nil for invalid/missing data instead of crashing.
+ (MLKVisionImage * _Nullable)visionImageFromData:(NSDictionary<NSString *, id> * _Nonnull)imageData SWIFT_WARN_UNUSED_RESULT;
@end
