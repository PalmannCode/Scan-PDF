...
#ifndef GOOGLE_MLKIT_TEXT_RECOGNITION_SWIFT_H
#define GOOGLE_MLKIT_TEXT_RECOGNITION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="google_mlkit_text_recognition",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC29google_mlkit_text_recognition32GoogleMlKitTextRecognitionPlugin")
