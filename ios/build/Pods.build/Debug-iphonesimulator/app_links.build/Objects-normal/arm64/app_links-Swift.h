...
@interface AppLinksIosPlugin : NSObject <FlutterPlugin, FlutterSceneLifeCycleDelegate, FlutterStreamHandler>
...
- (BOOL)scene:(UIScene * _Nonnull)scene willConnectToSession:(UISceneSession * _Nonnull)session options:(UISceneConnectionOptions * _Nullable)connectionOptions SWIFT_WARN_UNUSED_RESULT;
- (BOOL)scene:(UIScene * _Nonnull)scene openURLContexts:(NSSet<UIOpenURLContext *> * _Nonnull)URLContexts SWIFT_WARN_UNUSED_RESULT;
- (BOOL)scene:(UIScene * _Nonnull)scene continueUserActivity:(NSUserActivity * _Nonnull)userActivity SWIFT_WARN_UNUSED_RESULT;
